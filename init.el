...
Supports formats: 'Day Month D, YYYY' and 'Day M/D/YY'."
  ...
  (let ((emoji-data-file (expand-file-name "lisp/dp-cldr-emoji-data.el" dotspacemacs-directory)))
    (when (file-exists-p emoji-data-file)
      (load-file emoji-data-file)))
  
  ;; now call dp-generate-cldr-emoji-alist-to-file
